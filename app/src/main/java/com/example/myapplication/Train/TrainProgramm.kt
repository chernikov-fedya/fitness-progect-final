...
import com.example.myapplication.Man.MuscleGroup
...
object TrainProgramm {
    ...
    val listExcercise: Array<Excercise> = arrayOf(
        ...
        Excercise(
            "Приседания",
            " Ставим стопы на ширине плеч, а для большей устойчивости и максимального включения в работу ягодичных мышц, можно поставить их немного шире.\n" +
                    ...
                    "Если позволяет гибкость или есть желание максимально нагрузить ягодичные мышцы, то можно присесть глубже параллели. Не задерживаясь внизу, возвращаемся в исходную позицию ",
            (arrayOf(
                listMuscle[4],
                listMuscle[5]
            ))
        ...
        Excercise(
            "Становая тяга",
            "Возьмите пустой гриф (обычно его вес составляет 20 кг), встаньте перед ним, поставив ноги чуть уже плеч. Стопы должны быть параллельны друг другу. Выпрямите спину, таз отодвиньте назад (естественный прогиб в пояснице).\n" +
        ...
        Excercise(
            "Выпады",
            "Во время всего цикла выполнения выпада, вы должны держать верхнюю часть тела в вертикальном положении: " +
    ...
    init {
        listExcercise[0].diseases = arrayOf(
            listBroke[0], listBroke[4], listBroke[2])
        listExcercise[1].diseases = arrayOf(
            listBroke[2])
        listExcercise[2].diseases = arrayOf(
            listBroke[1], listBroke[4], listBroke[6], listBroke[8])
        listExcercise[3].diseases =
            listBroke
        listExcercise[4].diseases = arrayOf(
            listBroke[0], listBroke[2], listBroke[6])
        listExcercise[5].diseases = arrayOf(
            listBroke[1])
        listExcercise[6].diseases = arrayOf(
            listBroke[2], listBroke[6], listBroke[4])
        listExcercise[7].diseases = arrayOf(
            listBroke[3], listBroke[4], listBroke[8])
        listExcercise[8].diseases = arrayOf(
            listBroke[1], listBroke[3], listBroke[4], listBroke[5])
        listExcercise[9].diseases = arrayOf(
            listBroke[2], listBroke[6], listBroke[4])
        listExcercise[10].diseases = arrayOf(
            listBroke[8], listBroke[6])
        listExcercise[11].diseases = arrayOf(
            listBroke[1], listBroke[8])
        listExcercise[12].diseases = arrayOf(
            listBroke[3], listBroke[4], listBroke[6])
        listExcercise[13].diseases = arrayOf(
            listBroke[8])
        listExcercise[14].diseases = arrayOf(
            listBroke[8])
        listExcercise[15].diseases = arrayOf(
            listBroke[3], listBroke[4])
        listExcercise[16].diseases = arrayOf(
            listBroke[3], listBroke[4])
        listExcercise[17].diseases = arrayOf(
            listBroke[3], listBroke[4])
        listExcercise[18].diseases = arrayOf(
            listBroke[1])
    }
    ...
    fun checkExerciseChoose(muscle: List<Muscle>? = null): MutableList<Excercise> {
        ...
        if(actual1.isEmpty())
            actual1.add(
                Excercise(
                    "Извините, но вам противопоказаны занятия спортом",
                    "Извините, но вам противопоказаны занятия спортом."
                )
            )
        return actual1
