...
object TrainProgramm {
    ...
    val listExcercise: Array<Excercise> = arrayOf(
        ...
        Excercise("Становая тяга", "Оговорка: больше текста сложнее упражнение  \n" +
                "Возьмите пустой гриф (обычно его вес составляет 20 кг), встаньте перед ним, " +
                "поставив ноги чуть уже плеч. Стопы должны быть параллельны друг другу." +
                ...
                "При таком наклоне, плечи должны выходить чуть вперед за линию голеней." +
                " Колени при этом начнут сгибаться (градусов на 10—15) – это нормально. " +
                "Наклон корпуса должен составлять 40—45 градусов. Опустите руки вниз. " +
                "Если вы правильно наклонились, руки должны быть на одной линии с передней поверхностью голеней. " +
                "До грифа должно остаться совсем чуть-чуть. Присядьте, чтобы взять его. " +
                "При этом не отклоняйтесь корпусом вперед или назад. " +
                "Ваша главная задача, чтобы плечи двигались по строго вертикально оси. " +
                "Берем гриф правильным хватом (ладонями к себе). Плавно выпрямляем ноги, и только потом разгибаем спину." +
                " Когда вы повесите на гриф блины, вам не нужно будет так низко опускаться, чтобы взять штангу. " +
                ...
                "Затем начинайте опускаться – сначала сгибается спина где-то до 45 градусов " +
                "(следите за тем, чтобы плечи были ровно над грифом), потом и ноги. \n", (arrayOf(listMuscle[2], listMuscle[4]))), //3
        Excercise(
            "Жим от груди (лёжа)",
